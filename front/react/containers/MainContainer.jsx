...
class MainContainer extends Component {
  ...
  componentDidMount() {
    ...
    !sessionStorage.getItem("orders") && sessionStorage.setItem( "orders",JSON.stringify(this.props.orders));
  ...
  componentDidUpdate() {
    ...
    this.props.orders[0] && sessionStorage.setItem("orders",JSON.stringify(this.props.orders));
